...
export const Header13 = (props: Header13SlotProps) => {
	...
	return (
		<section className='flex h-screen md:h-full items-center justify-start gap-5 flex-col'>
			<div className='flex md:flex relative w-full  h-[60vh] xxl:h-[67vh] bg-zinc-950/10 flex-0'>
			...
			<div className='px-[5%]'>
				<div className='container'>
					<div className='grid grid-rows-1 md:mt-0 items-start gap-2 pb-12 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:gap-x-20 lg:gap-y-16'>
						<div>
							<Heading className='text-4xl md:text-5xl xxl:text-6xl font-bold capitalize'>
								{slot1}
							</Heading>
						</div>
						<div>
