...
export const Header13 = (props: Header13SlotProps) => {
	...
	return (
		<section className='flex min-h-screen h-full items-center justify-center md:justify-start gap-5 xxl:gap-8 flex-col shadow-small rounded-3xl'>
			...
			<div className='px-[5%]'>
				<div className='container'>
					<div className='grid grid-rows-1 mt-60 md:mt-0 items-start gap-2 pb-12 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:gap-x-20 lg:gap-y-16 '>
						<div>
							<Heading className='text-4xl md:text-5xl xl:text-6xl font-bold capitalize'>
								{slot1}
							</Heading>
						</div>
						<div>
