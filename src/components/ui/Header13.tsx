...
export const Header13 = (props: Header13SlotProps) => {
	...
	return (
		<section className='flex h-full min-h-screen items-center justify-start gap-5 md:gap-14 flex-col shadow-medium rounded-lg'>
			<div className='relative w-full h-[440px]  md:h-[580px] xxl:h-[680px] flex-0 bg-zinc-950/50'>
				<div className='absolute w-full top-0 left-0 h-[440px]  md:h-[580px] xxl:h-[680px]  -z-10'>
					<video
						className='object-cover object-center w-full h-[440px]  md:h-[580px] xxl:h-[680px] '
						autoPlay
						muted
						loop>
						<source
